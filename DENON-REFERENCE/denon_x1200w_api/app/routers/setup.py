...
def get_connection(request: Request) -> Dict[str, Any]:
    ...
    return {
        ...
        "hint": "Set DENON_HOST in integrations/denon_x1200w_api/.env (or the process environment).",
    }
...
def set_connection_disabled() -> None:
    raise HTTPException(
        ...
        {
            "error": "host_locked",
            "message": "AVR host is managed via DENON_HOST in .env — runtime IP changes are disabled.",
        },
    )
